...
def _dict_to_state(d: dict[str, Any]) -> FixtureState:
	return FixtureState(
		...
		clan_a=canonical_clan_name(str(d["clan_a"])),
		clan_b=canonical_clan_name(str(d["clan_b"])),
		round_no=int(d["round_no"]),
		division=d.get("division"),
		control_message_id=d.get("control_message_id"),
		proposed_datetime_utc=d.get("proposed_datetime_utc"),
		proposed_datetime_by=canonical_clan_name(d["proposed_datetime_by"]) if d.get("proposed_datetime_by") else None,
		...
		proposed_team_size_by=canonical_clan_name(d["proposed_team_size_by"]) if d.get("proposed_team_size_by") else None,
		...
		proposed_streamer_by=canonical_clan_name(d["proposed_streamer_by"]) if d.get("proposed_streamer_by") else None,
		...
		proposed_map_by=canonical_clan_name(d["proposed_map_by"]) if d.get("proposed_map_by") else None,
		map_history=d.get("map_history") or [],
		reroll_count_a=int(d.get("reroll_count_a", 0)),
		reroll_count_b=int(d.get("reroll_count_b", 0)),
		last_map_roll_by=canonical_clan_name(d["last_map_roll_by"]) if d.get("last_map_roll_by") else None,
		sides_reroll_count_a=int(d.get("sides_reroll_count_a", 0)),
		sides_reroll_count_b=int(d.get("sides_reroll_count_b", 0)),
		proposed_sides_allies=canonical_clan_name(d["proposed_sides_allies"]) if d.get("proposed_sides_allies") else None,
		proposed_sides_axis=canonical_clan_name(d["proposed_sides_axis"]) if d.get("proposed_sides_axis") else None,
		proposed_sides_by=canonical_clan_name(d["proposed_sides_by"]) if d.get("proposed_sides_by") else None,
		proposed_server_host=canonical_clan_name(d["proposed_server_host"]) if d.get("proposed_server_host") else None,
		sides_history=d.get("sides_history") or [],
		sides_allies=canonical_clan_name(d["sides_allies"]) if d.get("sides_allies") else None,
		sides_axis=canonical_clan_name(d["sides_axis"]) if d.get("sides_axis") else None,
		sides_decided_by=canonical_clan_name(d["sides_decided_by"]) if d.get("sides_decided_by") else None,
		server_host=canonical_clan_name(d["server_host"]) if d.get("server_host") else None,
